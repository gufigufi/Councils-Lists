...
function CouncilForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.error || 'Failed to save council. Please check the address and try again.');
        } finally {
            setLoading(false);
            setGeocoding(false);
        }
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <small className="form-hint">
                                This address will be automatically geocoded to place a marker on the map
                            </small>
                        </div>
                        ...
                        <div className="form-actions">
                            ...
                            >
                                {loading ? (
                                    ...
                                    isEditMode ? 'Update Council' : 'Create Council'
                                )}
                            </button>
                        </div>
                    </form>
